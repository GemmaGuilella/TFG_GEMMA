...
\definecolor{tw-pink}{RGB}{222, 49, 99}
\definecolor{tw-oxford-blue}{RGB}{2, 24, 43}
\setbeamercolor{palette primary}{bg=tw-oxford-blue,fg=white}
\setbeamercolor{background canvas}{bg=white}
\setbeamercolor{progress bar}{fg=tw-pink,bg=white}
...
\title[AppArkem]{Gestió automatitzada d'un pàrquing}
\subtitle{AppArkem}
